...
My first SEN Python assignment - Introduction to Programming
...
```bash
git clone https://github.com/Chuksleanna/First-SEN-201-Assignment-.git
```

2. Navigate to the project directory:
```bash
cd First-SEN-201-Assignment-
```
